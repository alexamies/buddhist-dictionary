...
<?php
	// If the word has a lat and long then create a map
    if (isset($words) && (count($words) == 1) && isset($word) && $word->getLl()) {
    	$ll = $word->getLl();
    	$zoom = $word->getZoom();
    	print(
                "<script src='http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAFaBkF4Tho1v-h3Q_xiWgtBQTGABMg42j1KMHWWzLHNC2KhYsSRS3P9nMv0ipFnkvrCQzzv2WYkhJmA&sensor=false'" .
                "        type='text/javascript'></script>\n" .
    	        "<script type='text/javascript'>\n" .
    			"function initialize() {\n" .
    			"  if (GBrowserIsCompatible()) {\n" .
    			"    var map = new GMap2(document.getElementById('map'));\n" .
    			"    var point = new GLatLng($ll);\n" .
    ...
    print("<title>汉英词典 Chinese English Dictionary: " . $title . "</title>\n" .
