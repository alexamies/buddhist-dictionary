...
python3 bin/tsv2json.py "data/dictionary/buddhist_terminology.txt" $OUTPUT_DIR/ntireader_words.json "NTI Reader Buddhist Dictionary" "NTI Reader" "Alex Amies" "Creative Commons Attribution-Share Alike 3.0"
