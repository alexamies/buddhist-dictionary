...
1. The web user interface. This includes HTML and JavaScript files.
   The site has changed from static site generation to a single page app
   using the framework in the
   [chinesenotes-frontend](https://github.com/alexamies/chinesenotes-frontend)
   repo. Generation of the HTML pages is therefore outside the scope of this
   project. The HTML files in the `html/` directory are content fragments
   served by that frontend framework.
